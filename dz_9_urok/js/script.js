...
const inputDepositAmount = document.querySelector('.deposit-amount');    // поле ввода скрыто
const inputDepositPercent = document.querySelector('.deposit-percent');  // поле ввода скрыто
...
const buttomCancel = document.querySelector('#cancel');  // кнопка скрыта.
